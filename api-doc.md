...
* [api](#module_api)
    ...
    * [~/cletlist()](#module_api../cletlist) ⇒ <code>Text</code>
    ...
    * [~onBlocked](#module_api..onBlocked) ⇒ <code>Void</code>
...
```
<a name="module_api../cletlist"></a>

### api~/cletlist() ⇒ <code>Text</code>
route to get list of hl2dm server clet's

**Kind**: inner method of [<code>api</code>](#module_api)  
**Returns**: <code>Text</code> - list of clet commands  
**Example** *(Example usage of /cletlist api endpoint.)*  
```js
...
| Param | Type | Description |
| --- | --- | --- |
| ms | <code>Number</code> | milliseconds the thread was blocked. |
